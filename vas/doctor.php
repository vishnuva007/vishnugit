...
<div class="sidebar">
    ...
    <i class='bx bxl-stripe'></i>
      ...
      <ul class="nav-links">
        <li>
          <a href="viewapp.php?id=<?php echo $docid;?>" class="active">
          <i class='bx bx-log-in-circle bx-fade-left' ></i>
            <span class="links_name">VIEW SCHEDULE</span>
          </a>
        </li><br>
        <li>
          <a href="viewans.php?id=<?php echo $docid;?>" class="active">
          <i class='bx bx-log-in-circle bx-fade-left' ></i>
            <span class="links_name">VIEW ANSWER</span>
          </a>
        </li><br>
        <li>
          <a href="consult.php?id=<?php echo $docid;?>" class="active">
          <i class='bx bx-log-in-circle bx-fade-left' ></i>
        ...
        <li>
          <a href="givepre.php?id=<?php echo $docid;?>" class="active">
          <i class='bx bx-log-in-circle bx-fade-left' ></i>
            <span class="links_name">GIVE PRESCRIPTION</span>
          </a>           
                  </li><br>
